...
public class CustomerSpecs {
	...
	public static <T> Specification<T> byAuto(
			final EntityManager entityManager, final T example) {
		...
		return new Specification<T>() {
			...
			public Predicate toPredicate(Root<T> root, CriteriaQuery<?> query,
				...
				EntityType<T> entity = entityManager.getMetamodel()
						.entity(type);
				...
				return predicates.isEmpty() ? cb.conjunction() : cb
						.and(toArray(predicates, Predicate.class));
			}
		};
	}
	...
	private static <E, T> SingularAttribute<T, E> attribute(
			EntityType<T> entity, String fieldName, Class<E> fieldClass) {
